...
<?php require('recaptcha/recaptcha_preview.php'); ?>
</head>
<body>
<header class="container-fluid headbg">
	...
	<section class="container-fluid space">
		<div class="container">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pre">Preview</div>
		
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 space" style="margin:80px 0 0 0;">
				<?php
			...
			<form method="post" action="<?php echo htmlspecialchars($_SERVER['REQUEST_URI'] . $_SERVER['QUERY_STRING']) ?>" id="contact_form"> <input type="hidden" name="do" value="contact">
				...
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 nopadding">
					...
					<div class="col-xs-12 col-sm-6 gederpage">
						<label  class="form_label">Male <input type="radio" name="a"> &nbsp;&nbsp;Female <input type="radio" name="a">
						</label>
					</div>
					...
					<div class="col-xs-12 col-sm-6 surname">Home Address</div>
					<div class="col-xs-12 col-sm-6"><input type="text" class="form-control txt"></div>
				...
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 nopadding">
					...
					<div class="col-xs-12 col-sm-6"><input type="text" class="form-control txt"></div>
					<div class="col-xs-12 col-sm-6 surname">Enter Code in box below</div>
					<div class="col-xs-12 col-sm-6">
